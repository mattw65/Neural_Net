...
print(abs(100*(abs(fit_cffs[0]-ReH_target[a]))/ReH_target[a]))
print(abs(100*(abs(fit_cffs[1]-ReE_target[a]))/ReE_target[a]))
print(abs(100*(abs(fit_cffs[2]-ReHT_target[a]))/ReHT_target[a]))
